...
public class SushiActivity extends AppCompatActivity {
    ...
    RecyclerView rvList;
    String[] Restaurants = {"Ginger", "Wasabi running", "Zen Sushi", "Kanpai"};
    int[] IMAGES = {R.drawable.ginger, R.drawable.wasabi, R.drawable.zen, R.drawable.kanpai};
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_no_smoke) {
                    Toast.makeText(SushiActivity.this, "No_smoke", Toast.LENGTH_SHORT).show();
