...
public class SteakHouseActivity extends AppCompatActivity {
    ...
    RecyclerView rvList;
    String[] Restaurants = {"OSHO", "Vacamuu", "Red Angus", "Vibes 19", "Argentine"};
    int[] IMAGES = { R.drawable.osho, R.drawable.vacamuuu,R.drawable.redangus,  R.drawable.vibes19 , R.drawable.argentine};
    @Override
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(id == R.id.nav_no_smoke){
                    Toast.makeText(SteakHouseActivity.this, "No_smoke",Toast.LENGTH_SHORT).show();
                }
                else
