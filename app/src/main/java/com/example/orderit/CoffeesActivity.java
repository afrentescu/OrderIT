...
public class CoffeesActivity extends AppCompatActivity {
    ...
    RecyclerView rvList;
    String[] Restaurants = { "Origo", "Ganesha", "Van Gogh", "Cereal Crunch" };
    int[] IMAGES = { R.drawable.origo, R.drawable.ganesha,R.drawable.vang,  R.drawable.cereal };
    @Override
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(id == R.id.nav_no_smoke){
                    Toast.makeText(CoffeesActivity.this, "No_smoke",Toast.LENGTH_SHORT).show();
                }
                else
